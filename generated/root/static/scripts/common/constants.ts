...
export const SPECIAL_ARTIST_GIDS: $ReadOnlyArray<string> = "WIP convertExpression: ArrayExpression";
export const SPECIAL_ARTIST_IDS: $ReadOnlyArray<number> = "WIP convertExpression: ArrayExpression";
...
export const BRACKET_PAIRS = "WIP convertExpression: ArrayExpression";
