...
export const ACCESS_SCOPE_PERMISSIONS: {} = "WIP convertExpression: ObjectExpression";
...
export const EDIT_VOTE_NONE = "WIP convertExpression: UnaryExpression";
export const EDIT_VOTE_ABSTAIN = "WIP convertExpression: UnaryExpression";
...
export const QUALITY_UNKNOWN = "WIP convertExpression: UnaryExpression";
...
export const PUBLIC_FLAGS: number = "WIP convertExpression: BinaryExpression";
